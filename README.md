...
### Добавление изменений в код (дополнительное задание)

1. ***Первое задание - Кликнуть, чтобы добавить бойда***

Сделал это по нажатию кнопки на клавиатуре (А), а также добавил прибавление по +10, чтобы быстрее происходило добавление бойдов на кнопку (S). И прописал все эти изменения в файле main.py в оносном цикле кода, покажу фрагмент добавленного кода
...
2. ***Второе задание - Удалить всех бойдов***

Сделал это по нажатию кнопки на клавиатуре (R) и прописал все эти изменения в файле main.py в оносном цикле кода, покажу фрагмент добавленного кода
...
3. ***Третье задание - Добавить новую функцию. Показать сколько бойдов на экране***

Также добавил в свой основной в файл main.py
